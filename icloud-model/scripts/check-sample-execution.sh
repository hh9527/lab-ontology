...
INSERT INTO I_EntNetworkElement VALUES ('A','red','A-red'),('A','blue','A-blue'),('B','red','B-red');
...
printf 'independent metric count and qualified observation execute correctly\n'
